...
assert.equal(
  ...
  '0.1.2-rc.1',
  'nishi-dsh-codex: peerDependencies must pin @deepseek-ai/dsh-attachment to 0.1.2-rc.1',
)
assert.equal(
  codexManifest.peerDependencies?.['@deepseek-ai/dsh-session'],
  '0.1.2-rc.1',
  'nishi-dsh-codex: peerDependencies must pin @deepseek-ai/dsh-session to 0.1.2-rc.1',
)
assert.equal(
...
assert.equal(suite.dependencies?.['@deepseek-ai/dsh-authorization'], '0.1.2-rc.1')
