...
import type { PublicProviderUsage, UsageLimitsPublicFacade, UsageLimitsService } from 'nishi-dsh-usage-limits'
import {
...
} from './antigravity-local-source.js'
...
export const name = 'usage-limits-host'
...
export const UsageLimitsHostPlugin = { name, inject, apply }
export default UsageLimitsHostPlugin
