...
export function dshClientPurityGatePlugin(): Plugin {
  ...
  return {
    ...
    resolveId(source) {
      ...
      if (source.startsWith('nishi-dsh-') && source !== 'nishi-dsh-usage-limits') {
...
function dshLightningCssModulesPlugin(): Plugin {
  return {
    ...
    load(id) {
      ...
      const cssId = `nishi-dsh-usage-limits-host:${fileKey}`
...
function __injectStyle(id, css) {
  ...
  if (doc && doc.createElement) {
    var el = doc.querySelector('style[data-plugin="nishi-dsh-usage-limits-host"][data-plugin-css="' + id + '"]');
    if (!el) {
      el = doc.createElement('style');
      el.setAttribute('data-plugin', 'nishi-dsh-usage-limits-host');
...
export default defineConfig([
  ...
  },
  {
    ...
    deps: {
      ...
      alwaysBundle: ['nishi-dsh-usage-limits', 'use-sync-external-store'],
    },
    banner:
      'window.__ModuleLoader__.load({\n  id: "nishi-dsh-usage-limits-host",\n  factory: (require) => {\n    var module = { exports: {} };\n    var exports = module.exports;\n',
