...
- `nishi-dsh-primary-web-search` — one primary-routed `web_search` tool for Codex and Antigravity;
...
Windows and CachyOS/Linux are independent supported installations. Session/state portability and cross-OS migration are not product goals. Project Memory stays inside each project checkout and is not synchronized or transported by the Suite.
